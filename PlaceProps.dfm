object PlacePropsForm: TPlacePropsForm
  ...
  object RecordGroupBox: TGroupBox
    ...
    Width = 433
    Height = 225
    Caption = #1059#1082#1072#1078#1080#1090#1077' '#1080#1085#1092#1086#1088#1084#1072#1094#1080#1102' '#1086#1073' '#1086#1073#1098#1077#1082#1090#1077
    TabOrder = 0
    ...
    object IdentityNameLabel: TLabel
      Left = 16
      Top = 120
      Width = 80
      Height = 13
